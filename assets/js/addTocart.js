...
//     const getOursons = document.querySelector('.container-ours')
...
//       <th class="w-20"><p class"h4">${data[i].name}</p></th>
//       <th class="w-20"><p class"h4">${data[i].price}</p></th>
...
//   <thead class="thead-dark">
//     <tr class="text-center">
//     <th class w-20><img src=${i.imageUrl} class="img-fluid img-thumbnail w-20"></th>
//       <th class="w-20"><p class"h4">${OP.name}</p></th>
//       <th class="w-20"><p class"h4">${OP.price}</p></th>
//       <td class="w-20"><button class="btn btn-info">Pay</button>
//       <td class="w-20"><button class="btn btn-info">Remove</button>
...
//  }
//  var nomNounours = JSON.parse(localStorage.getItem('cartId', OP.name))[2]
//  var prixNounours = JSON.parse(localStorage.getItem('cartId', OP.price))[0]
//  console.log(nomNounours)
//  function addToCartOurs(nomNounours){ 
//  var cartRow = document.createElement('div')
//  cartRow.classList.add('cart-row')
//  let productContainer= document.querySelector('.container-ours')[0]
// //  var cartRowContent 
//  productContainer.innerHtml = 
...
//   <thead class="thead-dark">
//     <tr class="text-center">
//     <th class w-20><img src=${OP.name} class="img-fluid img-thumbnail w-20"></th>
//       <th class="w-20"><p class"h4">${prixNounours}</p></th>
//       <th class="w-20"><p class"h4">${nomNounours}</p></th>
//       <th class="w-20"><button class="btn btn-info">Pay</button></th>
//       <th class="w-20"><button class="btn btn-info">Remove</button></th>
//      <!-- <th class="w-10">${nomNounours}</th>-->
...
// productContainer.appendChild(cartRow)
...
//   }
  ...
  // let response = await fetch('localStorage')
